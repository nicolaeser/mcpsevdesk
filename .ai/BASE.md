...
- For invoice, voucher, or tax-default work, [tool safety](instructions/tool-safety.md) must be
  loaded. Tax construction lives in `src/sevdesk/tax.ts`; do not invent tax rules.
